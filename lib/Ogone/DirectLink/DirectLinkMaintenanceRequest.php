...
class DirectLinkMaintenanceRequest extends AbstractDirectLinkRequest
{
    ...
    const TEST = "https://secure.payengine.de/ncol/test/maintenancedirect_utf8.asp";
    const PRODUCTION = "https://secure.payengine.de/ncol/prod/maintenancedirect_utf8.asp";
